        ...
        <div className="py-12 md:py-24 crtv-page-enter">
            <div className="max-w-5xl mx-auto">
                ...
                <div className="mt-24 grid grid-cols-2 md:grid-cols-4 gap-4">
                    {[1, 2, 3, 4].map(idx => (
                        <div key={idx} className="aspect-square  rounded-3xl border border-border flex items-center justify-center p-8 opacity-50 grayscale hover:opacity-100 hover:grayscale-0 transition-all cursor-crosshair">
