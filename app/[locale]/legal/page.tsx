        ...
        <PageContainer>
            <div className="py-12 md:py-24 crtv-page-enter">
                <div className="max-w-4xl mx-auto">
                    ...
                    <div className="bg-surface/30 backdrop-blur-2xl rounded-[3rem] border border-border overflow-hidden shadow-2xl relative">
                        <div className="p-8 md:p-16 space-y-12">
                            {paragraphs.slice(0, 2).map((p, i) => (
                                <p key={i} className="text-muted leading-relaxed text-xl italic font-serif border-l-4 border-accent pl-8 py-2">
                                    {p}
                                </p>
                            ))}

                            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 pt-6">
                                <div className="p-10 bg-background/50 rounded-3xl border border-border group hover:border-accent transition-colors">
                                    <div className="text-accent font-black mb-4 uppercase text-xs tracking-[0.2em]">{ti("legalEditor")}</div>
                                    <h3 className="text-xl font-bold mb-4">CRTV Group</h3>
                                ...
                                <div className="p-10 bg-background/50 rounded-3xl border border-border group hover:border-accent transition-colors">
                                    ...
                                    <h3 className="text-xl font-bold mb-4">iCAN Group</h3>
                                    <p className="text-muted leading-relaxed">
