                    ...
                    <div className="grid grid-cols-1 md:grid-cols-12 gap-12 items-start">
                        ...
                        <div className="md:col-span-7 space-y-8">
                            {paragraphs.slice(0, 2).map((p, i) => (
                                <div key={i} className="relative p-8 bg-surface/50 backdrop-blur-md rounded-3xl border border-border shadow-xl">
                                    ...
                                    <p className="text-lg leading-relaxed text-foreground/90 italic font-serif">
                                        "{p}"
                                    </p>
                                </div>
                            ))}
                        ...
                        <div className="md:col-span-5 md:pt-20">
                            <div className="bg-accent p-1 rounded-2xl rotate-3 shadow-2xl overflow-hidden group">
                                <div className="bg-background p-8 rounded-xl -rotate-3 transition-transform group-hover:rotate-0 duration-500">
