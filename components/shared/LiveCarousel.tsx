    ...
    return (
        <div className="relative group/carousel w-full">
            ...
            {showLeftBtn && (
                <button
                    onClick={() => scroll("left")}
                    className="absolute left-0 top-[78px] -translate-y-1/2 z-20
                               bg-black/60 hover:bg-[color:var(--accent)] backdrop-blur-xl
                               text-white w-10 h-16 flex items-center justify-center
                               border-y border-r border-white/20 transition-all duration-300
                               opacity-0 group-hover/carousel:opacity-100 rounded-r-lg"
                    aria-label="Previous"
                >
            ...
            {showRightBtn && (
                <button
                    ...
                    className="absolute right-0 top-[78px] -translate-y-1/2 z-20
                               bg-black/60 hover:bg-[color:var(--accent)] backdrop-blur-xl
                               text-white w-10 h-16 flex items-center justify-center
                               border-y border-l border-white/20 transition-all duration-300
                               opacity-0 group-hover/carousel:opacity-100 rounded-l-lg"
                    aria-label="Next"
                >
                    <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <div
                ...
                className="flex gap-[13px] overflow-x-auto pb-l pt-xxs scroll-smooth [scrollbar-width:none] [&::-webkit-scrollbar]:hidden"
            >
