...
interface LiveCinematicPlayerProps {
    channel: LiveChannel;
}

export function LiveCinematicPlayer({ channel }: LiveCinematicPlayerProps) {
    ...
    return (
        <div ref={containerRef} className="w-full overflow-hidden group/player mb-8 rounded-3xl border border-white/5 bg-black shadow-2xl">
